  ...
  return (
    ...
    <div data-aos="flip-left" className="main-main-1 container-fluid">
      <div className="main-left col-6">
        ...
        <a href="https://drive.google.com/uc?export=download&id=1fhvpH9UWZWVMI3kpYWQknNDFjEBEhW4z"  style={{textDecoration:"None" , color:'white',cursor:'pointer'}} download><button className="main-button-1">Download CV</button></a>
      </div>
